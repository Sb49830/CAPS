...
var DestinationFromServiceRetriever = /** @class */ (function () {
    function DestinationFromServiceRetriever(name, options, decodedUserJwt, providerToken) {
        this.name = name;
        this.decodedUserJwt = decodedUserJwt;
        this.providerToken = providerToken;
        this.options = __assign({}, options);
        this.decodedProviderToken = jwt_1.decodeJwt(providerToken);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, DestinationFromServiceRetriever.getProviderToken(options)];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, da.addOAuthSamlAuth(destination)];
                    case 4:
                        destination = _a.sent();
                        _a.label = 5;
                    case 5:
                        if (!(destination.authentication === 'ClientCertificateAuthentication')) return [3 /*break*/, 7];
    ...
    DestinationFromServiceRetriever.getProviderToken = function (options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    DestinationFromServiceRetriever.prototype.addOAuthSamlAuth = function (destination) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!destinationService) {
                            throw Error("Failed to fetch destination \"" + this.name + "\"! No binding to a destination service found.");
                        }
                        if (destination.systemUser) {
                            logger.debug("System user found on destination. The provider token: " + this.providerToken + " is used for destination fetching");
                            return [2 /*return*/, destination_service_1.fetchDestination(destinationService.credentials.uri, this.providerToken, this.name, this.options)];
                        }
                    ...
                    case 1:
                        accessToken = _a.sent();
                        return [2 /*return*/, destination_service_1.fetchDestination(destinationService.credentials.uri, accessToken, this.name, this.options)];
                }
            });
        });
    };
    ...
    DestinationFromServiceRetriever.prototype.updateDestinationCache = function (destination, destinationOrigin) {
        ...
        destination_cache_1.destinationCache.cacheRetrievedDestination(destinationOrigin === 'subscriber'
            ? this.decodedUserJwt
            : this.decodedProviderToken, destination, this.options.isolationStrategy);
    };
    DestinationFromServiceRetriever.prototype.getProviderDestinationService = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getInstanceAndSubaccountDestinations(this.providerToken)];
                    case 1:
                        provider = _a.sent();
    ...
    DestinationFromServiceRetriever.prototype.getProviderDestinationCache = function () {
        var destination = destination_cache_1.destinationCache.retrieveDestinationFromCache(this.decodedProviderToken, this.name, this.options.isolationStrategy);
        if (destination) {
    ...
    DestinationFromServiceRetriever.prototype.isProviderAndSubscriberSameTenant = function () {
        return (this.decodedUserJwt &&
            jwt_1.isIdenticalTenant(this.decodedUserJwt, this.decodedProviderToken));
    };

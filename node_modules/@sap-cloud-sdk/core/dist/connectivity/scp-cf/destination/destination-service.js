    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, callDestinationService(targetUri, jwt, options)
                    ...
                    if (options === null || options === void 0 ? void 0 : options.useCache) {
                        destination_service_cache_1.destinationServiceCache.cacheRetrievedDestinations(targetUri, jwt_1.decodeJwt(jwt), [destination], options.isolationStrategy);
                    }
                    return destination;
                })
                    .catch(function (error) {
...
function callDestinationService(uri, jwt, options) {
    ...
    var config = __assign(__assign({}, http_client_1.getAxiosConfigWithDefaults()), { url: uri, headers: jwt_1.wrapJwtInHeader(jwt).headers });

...
exports.RestRequestBuilder = void 0;
...
var RestRequestBuilder = /** @class */ (function () {
     ...
     */
    function RestRequestBuilder(apiConstructor, fn) {
        var args = [];
     ...
     */
    RestRequestBuilder.prototype.withCustomHeaders = function (headers) {
        var _this = this;
     ...
     */
    RestRequestBuilder.prototype.execute = function (destination) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        api = new this.apiConstructor(requestConfig);
                        fn = api[this.fn];
                        if (typeof fn === 'function') {
                            return [2 /*return*/, fn.apply(api, this.args)];
                        }
                        throw new Error("'" + this.fn + "' is not a function of " + this.apiConstructor.name);
                }
            });
        });
    };
...
//# sourceMappingURL=rest-request-builder.js.map